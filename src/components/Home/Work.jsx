  ...
  return (
    <div className='work my-[110px]'>
        <div className="container-sectionn w-[90%] m-auto">
            <h1 className='text-[24px] lg:text-[38px] font-[600] leading-8 lg:leading-[50px] text-center uppercase'>we work with top <span className='text-[#82631C]'>clients</span></h1>
